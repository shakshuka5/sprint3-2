<template>
  <section v-if="books">
    ...
    <ul>
      <book-preview v-for="currBook in emailsToDisplay" :key="currBook.id" @click.native="selectBook(currBook)" @edit="editBook(currBook)" @delete="deleteBook(currBook)" @addToCart="addToCart(currBook)" @substractFromCart="substractFromCart(currBook)" :book="currBook">
      </book-preview>
    </ul>
